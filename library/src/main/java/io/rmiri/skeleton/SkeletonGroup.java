  ...
  protected void dispatchDraw(Canvas canvas) {
    ...
    if (isCanDraw) {
      ...
      if (paintGradient == null) {
        ...
        Canvas canvasBackgroundElement = new Canvas(bitmapBackgroundElement);
        bitmapGradientElement = Bitmap.createBitmap(getWidth(), getHeight(), bitmapConfig);
        Canvas canvasGradientElement = new Canvas(bitmapGradientElement);
  ...
  private void setupInitialAnimation() {
    ...
    valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
      ...
      public void onAnimationUpdate(ValueAnimator animation) {
        AnimationFractionMove = (float) animation.getAnimatedValue();
